...
namespace LibGL::Physics
{
     ...
     */
    std::vector<ICollider*> overlapBox(const LibMath::Vector3& center, const LibMath::Vector3& size);
     ...
     */
    std::vector<ICollider*> overlapSphere(const LibMath::Vector3& center, float radius);
     ...
     */
    std::vector<ICollider*> overlapCapsule(const LibMath::Vector3& center, const LibMath::Vector3& up, float height, float radius);
}
