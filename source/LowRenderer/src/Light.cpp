...
namespace My::Rendering
{
	...
	void Light::setupUniform(const std::string& uniformName, const Shader& shader) const
	{
	...
	void DirectionalLight::setupUniform(const std::string& uniformName, const Shader& shader) const
	{
	...
	void PointLight::setupUniform(const std::string& uniformName, const Shader& shader) const
	{
		Light::setupUniform(uniformName, shader);
	...
	void SpotLight::setupUniform(const std::string& uniformName, const Shader& shader) const
	{
		Light::setupUniform(uniformName, shader);
