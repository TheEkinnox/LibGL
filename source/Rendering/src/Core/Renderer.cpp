...
namespace LibGL::Rendering
{
    ...
    void Renderer::clear(const bool colorBuffer, const bool depthBuffer, const bool stencilBuffer) const
    {
        glClear
        (
    ...
    void Renderer::setCapability(const ERenderingCapability renderingCapability, const bool enable) const
    {
    ...
    void Renderer::setColorWriting(const bool enableRed, const bool enableGreen, const bool enableBlue,
                                   const bool enableAlpha) const
    {
