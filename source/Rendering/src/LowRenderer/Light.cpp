...
namespace LibGL::Rendering
{
    ...
    Matrix4 Light::getMatrix() const
    {
        ...
        lightMat[Matrix4::getIndex(0, 0)] = m_color.m_r;
        lightMat[Matrix4::getIndex(0, 1)] = m_color.m_g;
        lightMat[Matrix4::getIndex(0, 2)] = m_color.m_b;
        lightMat[Matrix4::getIndex(0, 3)] = m_color.m_a;

        lightMat[Matrix4::getIndex(3, 3)] = static_cast<float>(ELightType::AMBIENT);
    ...
    Matrix4 DirectionalLight::getMatrix() const
    {
        ...
        lightMat[Matrix4::getIndex(1, 0)] = m_direction.m_x;
        lightMat[Matrix4::getIndex(2, 0)] = m_direction.m_y;
        lightMat[Matrix4::getIndex(3, 0)] = m_direction.m_z;

        lightMat[Matrix4::getIndex(3, 3)] = static_cast<float>(ELightType::DIRECTIONAL);
    ...
    Matrix4 PointLight::getMatrix() const
    {
        ...
        lightMat[Matrix4::getIndex(1, 1)] = m_position.m_x;
        lightMat[Matrix4::getIndex(2, 1)] = m_position.m_y;
        lightMat[Matrix4::getIndex(3, 1)] = m_position.m_z;

        lightMat[Matrix4::getIndex(1, 2)] = m_attenuationData.m_constant;
        lightMat[Matrix4::getIndex(2, 2)] = m_attenuationData.m_linear;
        lightMat[Matrix4::getIndex(3, 2)] = m_attenuationData.m_quadratic;

        lightMat[Matrix4::getIndex(3, 3)] = static_cast<float>(ELightType::POINT);
    ...
    Matrix4 SpotLight::getMatrix() const
    {
        ...
        lightMat[Matrix4::getIndex(1, 3)] = m_cutoff.m_inner;
        lightMat[Matrix4::getIndex(2, 3)] = m_cutoff.m_outer;

        lightMat[Matrix4::getIndex(3, 3)] = static_cast<float>(ELightType::SPOT);
