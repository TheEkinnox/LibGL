...
My::Resources::Texture::Texture(const std::filesystem::path& fileName)
{
...
My::Resources::Texture::Texture(const Texture& other) :
	m_id(other.m_id), m_width(other.m_width), m_height(other.m_height),
	m_channels(other.m_channels)
{
}

My::Resources::Texture::Texture(Texture&& other) noexcept :
	m_id(other.m_id), m_width(other.m_width), m_height(other.m_height),
	m_channels(other.m_channels)
{
	other.m_id = 0;
...
My::Resources::Texture::~Texture()
{
	glDeleteTextures(1, &m_id);
}

My::Resources::Texture& My::Resources::Texture::operator=(const Texture& other)
{
	if (&other == this)
		return *this;
...
My::Resources::Texture& My::Resources::Texture::operator=(Texture&& other) noexcept
{
	if (&other == this)
		return *this;
...
bool My::Resources::Texture::loadFromFile(const std::string& fileName)
{
